[← Lab 2 Guide](labguide2.md) · **Step 3 of 5**
...
| ← Previous | ↑ Guide | Next → |
|:--|:--:|--:|
| [Step 2 — Create the (Broken) App](2-create-broken-app.md) | [Lab 2 Guide](labguide2.md) | [Step 4 — Prompt the Agent to Fix It](4-prompt-agent-to-fix.md) |
